    ...
    <div class="max-w-md w-full relative z-10">
        ...
        <div class="glass-card bg-white/80 backdrop-blur-xl rounded-3xl p-8 md:p-10 animate-scale-in border border-white/50 shadow-2xl">
            ...
            <form method="POST" action="{{ route('login') }}" class="space-y-5">
                ...
                <div class="flex items-center justify-between pt-1">
                    <label class="flex items-center cursor-pointer group">
                        ...
                        >
                        <span class="ml-2 text-sm text-gray-600 group-hover:text-primary transition font-medium">Se souvenir de moi</span>
                    </label>
                    
                    @if (Route::has('password.request'))
                        <a href="{{ route('password.request') }}" class="text-sm text-secondary hover:text-primary transition font-bold">
                            Mot de passe oublié ?
                        </a>
                    @endif
                </div>
                ...
                >
                    Se connecter <i class="fas fa-arrow-right ml-2 text-sm"></i>
                </button>
            </form>
            ...
            <div class="text-center">
                <p class="text-gray-600 mb-4 font-medium">Vous n'avez pas de compte ?</p>
                <a 
                    href="{{ route('register') }}" 
                    class="block w-full py-3.5 border-2 border-dashed border-gray-300 text-gray-600 rounded-xl font-bold hover:border-secondary hover:text-secondary hover:bg-secondary/5 transition group"
                >
